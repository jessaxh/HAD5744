...
tbl_merge(tbls = list(q_e_matched_table, unmatched_table)) # we can get rid of this if we want 
...
Conditional independence assumption. This assumption is met because ... # I have no brain cells to think about backdoors/DAGs right no LOL
