...
- Medicare protects low-income people 65 years or older from the risk of high out-of-pocket health expenditures as well as eliminating a financial barrier in accessing care. We can see this in (e), where there is a substantial difference in total expenditure, this is primarily among low-income individuals
...
- Potential open back doors: As we see large differences in quantiles on total expenditure in (d), a potential open back door that may be influencing this result is health status. Regardless of medicare coverage, health status will increase health expenditure.
