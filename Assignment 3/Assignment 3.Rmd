...
fixed_effects_model <- feols(hits~treated + pandemic_begun + interaction, data = new_regdata) #idk what fixed effects we have to include here also not sure if we include all 3 of these variables in the ols 
fixed_effects_model
