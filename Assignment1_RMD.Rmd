...
When we log transform our model, we see a change in direction for the relationship between HXPC and LEBF with a one unit increase in HXPC associated with a 0.0014 unit decrease in LEBF (when holding GDPPC constant), however, the relationship continues to be not statistically significant. For the log-transformed relationship between GDPPC and LEBF (when keeping HXPC constant), we continue to see a positive significant relationship; however, a 10% increase in GDDPC is significantly associated with a 0.3921442 increase in LEBF which is a dramatic increase from the non-transformed model where GDDPC was significantly associated with a 0.0005 increase in LEBF.
